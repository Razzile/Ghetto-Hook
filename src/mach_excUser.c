/*
 * IDENTIFICATION:
 * stub generated Thu Sep  3 12:08:59 2015
...
mig_internal kern_return_t __MIG_check__Reply__mach_exception_raise_t(
    __Reply__mach_exception_raise_t *Out0P) {
...
/* BEGIN VOUCHER CODE */
  ...
  __BeforeSendRpc(2405, "mach_exception_raise") msg_result = mach_msg(
      &InP->Head, MACH_SEND_MSG | MACH_RCV_MSG | MACH_MSG_OPTION_NONE,
      msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port,
      MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
  __AfterSendRpc(2405,
                 "mach_exception_raise") if (msg_result != MACH_MSG_SUCCESS) {
    __MachMsgErrorWithoutTimeout(msg_result);
    { return msg_result; }
  }

#if defined(__MIG_check__Reply__mach_exception_raise_t__defined)
  check_result = __MIG_check__Reply__mach_exception_raise_t(
      (__Reply__mach_exception_raise_t *)Out0P);
...
mig_internal kern_return_t __MIG_check__Reply__mach_exception_raise_state_t(
  ...
  if ((Out0P->Head.msgh_bits & MACH_MSGH_BITS_COMPLEX) ||
      ((msgh_size > (mach_msg_size_t)sizeof(__Reply) ||
        msgh_size < (mach_msg_size_t)(sizeof(__Reply) - 896)) &&
  ...
  if (Out0P->new_stateCnt > 224)
    return MIG_TYPE_ERROR;
  if (((msgh_size - (mach_msg_size_t)(sizeof(__Reply) - 896)) / 4 <
       Out0P->new_stateCnt) ||
      (msgh_size !=
       (mach_msg_size_t)(sizeof(__Reply) - 896) + Out0P->new_stateCnt * 4)) {
    return MIG_TYPE_ERROR;
  }
#endif /* __MigTypeCheck */
...
#pragma pack()
  ...
  (void)memcpy((char *)InP->old_state, (const char *)old_state,
               4 * old_stateCnt);
...
/* BEGIN VOUCHER CODE */
  ...
  __BeforeSendRpc(2406, "mach_exception_raise_state") msg_result = mach_msg(
      &InP->Head, MACH_SEND_MSG | MACH_RCV_MSG | MACH_MSG_OPTION_NONE,
      msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port,
      MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
  __AfterSendRpc(2406, "mach_exception_raise_state") if (msg_result !=
                                                         MACH_MSG_SUCCESS) {
    __MachMsgErrorWithoutTimeout(msg_result);
    { return msg_result; }
  }
...
#if defined(__MIG_check__Reply__mach_exception_raise_state_t__defined)
  check_result = __MIG_check__Reply__mach_exception_raise_state_t(
      (__Reply__mach_exception_raise_state_t *)Out0P);
  if (check_result != MACH_MSG_SUCCESS) {
    return check_result;
  }
  ...
  *flavor = Out0P->flavor;
  ...
  (void)memcpy((char *)new_state, (const char *)Out0P->new_state,
               4 * Out0P->new_stateCnt);
...
__MIG_check__Reply__mach_exception_raise_state_identity_t(
...
/* BEGIN VOUCHER CODE */
  ...
  __BeforeSendRpc(2407, "mach_exception_raise_state_identity") msg_result =
      mach_msg(&InP->Head, MACH_SEND_MSG | MACH_RCV_MSG | MACH_MSG_OPTION_NONE,
               msgh_size, (mach_msg_size_t)sizeof(Reply),
               InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE,
               MACH_PORT_NULL);
  __AfterSendRpc(2407,
                 "mach_exception_raise_state_identity") if (msg_result !=
                                                            MACH_MSG_SUCCESS) {
    __MachMsgErrorWithoutTimeout(msg_result);
    { return msg_result; }
  }
